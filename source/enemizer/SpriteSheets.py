...
def setup_required_dungeon_groups(sheets, data_tables, limited_run=False):
    ...
    free_sheet_reqs = [
        ...
        ([None, None, None, (82, 83)], [0x13, 0x23, 0x96, 0xa5, 0xc5, 0xd5] + ([0x101] if limited_run else [])),
        ...
        ([None, None, None, 83], [0x3f, 0xce] + ([0x5f] if limited_run else [])),  # pull tongue
...
def randomize_underworld_sprite_sheets(sheets, data_tables, custom_enemies, limited_run=False):
